...
public class roomThirteenAndThreeQuarters extends World
{
    ...
    {    
        ...
        for(int i = 0; i < 5; i++){ //N
                addObject(new teleporter(worldMaster.getWorlds().get(13),"horizBorderControl.png"), 300 + 30 * i, 50);
        }
        addObject(new door("topDoor.PNG"), 375, 25);
        for(int i = 0; i < 5; i++){ //S
                addObject(new teleporter(worldMaster.getWorlds().get(9),"horizBorderControl.png"), 300 + 30 * i, 700);
        }
